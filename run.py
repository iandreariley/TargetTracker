...
def evaluate_detector_on_sequence(detection_algo, sequence_path, visualize):
    ...
    target_tracker = tracker.SimpleTracker(sequence, detection_algo, initial_location)
...
def run_single_session(args):
    if args.evaluate:
        ...
        results, distance_threshold = evaluate_detector_on_sequence(detection_algo, args.sequence_source, args.visualize)
...
def run_benchmark(args):
    ...
    for sequence in benchmark_sequences:
        ...
        results, distance_threshold = evaluate_detector_on_sequence(detection_algo, sequence_path, args.visualize)
