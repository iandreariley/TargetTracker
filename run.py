...
def evaluate_detector_on_sequence(detection_algo, sequence_path):
...
def run_single_session(args):
    if args.evaluate:
        ...
        results, distance_threshold = evaluate_detector_on_sequence(detection_algo, args.sequence_source)
